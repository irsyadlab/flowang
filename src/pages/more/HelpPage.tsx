    ...
    sections: [
      {
        ...
        content: (
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>Langkah pertama yang disarankan:</p>
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            <p>Halaman Laporan menyediakan tiga jenis analisis keuangan:</p>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            <p>Halaman Piutang membantu kamu melacak hutang dan piutang per kontak.</p>
            <ul className="space-y-1.5 mt-1">
              {[
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            <p>Kategori membantu mengelompokkan transaksi agar laporan lebih informatif.</p>
            <ul className="space-y-1.5 mt-1">
              {[
    ...
    sections: [
      {
        ...
        content: (
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            <p>Halaman Pengaturan menyediakan opsi sinkronisasi, backup, dan tampilan.</p>
            <ul className="space-y-2 mt-1">
              {[
                {
                  label: "Sync Key",
              ...
              <Accordion type="multiple">
                {group.sections.map((section) => (
                  <AccordionItem key={section.id} value={section.id} className="border-0">
                    <AccordionTrigger className="px-4 py-3.5 hover:bg-muted/50 hover:no-underline [&>svg]:text-muted-foreground">
